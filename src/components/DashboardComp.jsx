...
const DashboardComp = () => {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        const res = await axios.get(`${ENV.BACKEND_URL}/api/user/getusers?limit=5`, {
    ...
    const fetchPosts = async () => {
      try {
        const res = await axios.get(`${ENV.BACKEND_URL}/api/post/getposts?limit=5`, {
          withCredentials: true,
        });
    ...
    const fetchComments = async () => {
      try {
        const res = await axios.get(`${ENV.BACKEND_URL}/api/comment/getAllComment?limit=5`, {
          withCredentials: true,
        });
